...
public class JsonAbstractHttpMessageConverter extends AbstractHttpMessageConverter<Object> {
	...
	//	private static final Logger logger = Logger.getLogger(JsonAbstractHttpMessageConverter.class);
	...
	protected void writeInternal(Object o, HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
		//		SerializerFeature[] sf = { SerializerFeature.PrettyFormat, SerializerFeature.WriteNullListAsEmpty,
