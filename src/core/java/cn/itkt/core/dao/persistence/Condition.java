...
public class Condition implements Serializable {
     ...
     */
    public Condition(String propName,String signal,Object value,String paramName,boolean isDefaultAlias,String alias){
        this.property = propName;
        this.signal = signal;
        this.value = value;
        this.paramName = paramName;
        ...
        if(!this.isDefaultAlias&&StringUtils.isBlank(this.alias)){
        	throw new InvalidArgumentException("不使用默认别名的情况下,别名不能为空");
        }
    }
