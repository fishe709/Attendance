...
public class TimeExchange {
    ...
    public static void main(String [] args) throws Exception{
        ...
        System.out.println(StringToTimestamp(df.format(d)));
        System.out.println(TimestampToDate(1415106213));
        
        DateFormat dff = new SimpleDateFormat("yyyy-MM-dd");
        String start = dff.format(new Date())+ " 00:00:00";
        String end = dff.format(new Date())+ " 23:59:59";
